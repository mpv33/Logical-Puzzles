...
function setNumber(){
    ...
    c=Math.floor(Math.random() * 10 + 14);
    d=Math.floor(Math.random() * 10 + 24);
    e=Math.floor(Math.random() * 10 + 35);
    f=Math.floor(Math.random() * 10 + 45);
    g=Math.floor(Math.random() * 10 + 55);
    h=Math.floor(Math.random() * 10 + 65);
    i=Math.floor(Math.random() * 10 + 75);
}
function sol(){
    $('.answers').hide();
    $('.hid').hide();
